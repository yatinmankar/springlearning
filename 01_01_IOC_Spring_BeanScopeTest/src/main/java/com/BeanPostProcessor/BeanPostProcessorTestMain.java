...
public class BeanPostProcessorTestMain {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
	//	Resource resource 
		//BeanFactory   context = new XmlBeanFactory(new ClassPathResource("xmlFIle/postProcessor/bean-scope.xml"));
		AbstractApplicationContext context = new ClassPathXmlApplicationContext("xmlFIle/postProcessor/bean-scope.xml");
