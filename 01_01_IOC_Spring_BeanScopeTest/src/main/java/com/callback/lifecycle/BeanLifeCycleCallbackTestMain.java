package com.callback.lifecycle;
...
public class BeanLifeCycleCallbackTestMain {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
	//	Resource resource 
		//BeanFactory   context = new XmlBeanFactory(new ClassPathResource("xmlFIle/bean-scope.xml"));
		AbstractApplicationContext context = new ClassPathXmlApplicationContext("xmlFIle/lifecycle_callback_xml/bean-scope.xml");
