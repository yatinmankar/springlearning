...
import com.spring.xmlConfiguration.TennisCoach;
import com.spring.xmlConfiguration1.HockyCoach;
import com.spring.xmlConfiguration1.Team;

@ComponentScan("com.spring.xmlConfiguration;com.spring.xmlConfiguration1")

public class ApplicationJavaConfigMain {
	...
	public static void main(String[] args) {
		...
		AnnotationConfigApplicationContext context=new AnnotationConfigApplicationContext(ApplicationJavaConfigMain.class);
